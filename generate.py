...
ser = serial.Serial(8, 38400, timeout=1)
...
qq = [
 ...
 [0x01, 0x81, 0x0A, 0x1F, 0x01, 0x17, 0xA1, 0x08, 0x00, 0x6C], #EPC error open line reset
  ...
  [0x01, 0x81, 0x0A, 0x1F, 0x01, 0x05, 0xA1, 0x08, 0x00, 0x5A], #arnoError1 48
  [0x01, 0x81, 0x0A, 0x1F, 0x01, 0x05, 0xA1, 0x01, 0x00, 0x53], #arnoError2

  [0x01,0x81,0x0A,0x1F,0x01,0x05,0x81,0x00,0x08,0x3A], #Master - slave1 communication error set 50
  [0x01,0x81,0x0A,0x1F,0x01,0x16,0x81,0x00,0x08,0x4B], #reset
