...
erros = [
       ...
       [0x01, 0x81, 0x0A, 0x1F, 0x01, 0x17, 0xA1, 0x08, 0x00, 0x6C], #EPC error open line reset
        ...
        [0x01, 0x81, 0x0A, 0x1F, 0x01, 0x05, 0x81, 0x01, 0x01, 0x34], #slave has errors 50

        [0x01, 0x81, 0x0A, 0x1F, 0x01, 0x09, 0x05, 0x00, 0x20, 0xDA], #impedance deviation 5a open line set 51

        [0x01, 0x81, 0x0A, 0x1F, 0x01, 0x05, 0xA1, 0x00, 0x08, 0x5A], #mains error contact active set 52
      ]